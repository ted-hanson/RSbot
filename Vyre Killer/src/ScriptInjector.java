...
public class ScriptInjector {
    ...
    private static final String RSBOT_DICTIONARY = "RSBot.jar"; //- EXAMPLE (This is not a requirement if rsbot is in project folder)
    ...
    public static void main(final String[] args) {
        ...
        if(RSBOT_DICTIONARY != null)
            ...
            throw new Error("NO PATH SPECIFIED FOR RSBOT");
        }
